 ...
 * @Author:TanLongYue
 * @Description
 * @Date Created in 2020/10/19 22:42
 * @Modified By
 */
@Configuration
...
//     }
    ...
    public CutromRelm cutromRelm(){
        ...
        cutromRelm.setAuthenticationCacheName("SESSION");
...
//        redisManager.setHost("192.168.146.128:6379");
...
//        //设置一个redis缓存时间  秒为单位
//        redisCacheManager.setExpire(7200);
